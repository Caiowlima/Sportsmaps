...
--
-- Host: localhost
-- Tempo de geração: 04-Jun-2025 às 01:11
...
--
ALTER TABLE `tab_disponibilidade`
  ADD CONSTRAINT `tab_disponibilidade_ibfk_1` FOREIGN KEY (`fk_id_mod_empresa`) REFERENCES `tab_mod_empresa` (`id_mod_empresa`);
COMMIT;
